...
const int pin_Right_Motor = 8;
const int pin_Left_Motor = 9;
const int pin_Arm_Motor = 10;
const int pin_Grip_Motor = 11;
const int pin_Motor_Enable_Switch = 12;
...
void setup() {
  ...
  pinMode(pin_Motor_Enable_Switch, INPUT);
...
void loop()
{
  ...
  bt_Motors_Enabled = digitalRead(pin_Motor_Enable_Switch);
